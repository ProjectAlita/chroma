...
>
    ...
    methods: {
        ...
        handleEdit(data) {
            console.debug('chroma editIntegration', data)
...
register_component('chromaIntegration', chromaIntegration)
